...
const ToggleMedia:FC<ToggleMediaProps> = ({ className, active, type, ...args }: ToggleMediaProps) => {
	return (
		<button className={classNames(cls?.ToggleMedia, { [cls.Off]: !active }, [className])} {...args}>
